...
// 
// Revision:
// Revision 0.2 - Packed array test
// Additional Comments:
// 
//////////////////////////////////////////////////////////////////////////////////

module lab2b_top #(
	parameter [3:0][31:0] G_CLK_FREQUENCY = '{
		32'd800_000_000, 32'd400_000_000, 32'd200_000_000, 32'd100_000_000}, // Hz
	parameter      G_BLINK_PERIOD  = 1, // s
	parameter int  G_CNT_NUM       = $size(G_CLK_FREQUENCY), // number of independent counters
